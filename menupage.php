...
function menu_page()
{
	...
	function register_app(){
		global $options;
		$pk = wp_filter_nohtml_kses($options['app_key']);
		$host_name = wp_filter_nohtml_kses($_SERVER['SERVER_NAME']);
		$ip = wp_filter_nohtml_kses($_SERVER['REMOTE_ADDR']);
		$req = "pk=".$pk."&host=".$host_name."&ip=".$ip;
		$host = 'www.captcha.in.th';
		$path = '/register_wp/register.php';
		$port = 80;
		$http_request  = "POST $path HTTP/1.0\r\n";
        $http_request .= "Host: $host\r\n";
        $http_request .= "Content-Type: application/x-www-form-urlencoded;\r\n";
        $http_request .= "Content-Length: " . strlen($req) . "\r\n";
        $http_request .= "User-Agent: CAPTCHA IN THAI/PHP\r\n";
        $http_request .= "\r\n";
        $http_request .= $req;
...
function menu_page_user_agreement(){
	...
	<center>
		...
		<div style="width: 800px; height: 400px; overflow-y: scroll; scrollbar-arrow-color:blue; scrollbar-face-color: #e7e7e7; scrollbar-3dlight-color: #a0a0a0; scrollbar-darkshadow-color:#888888">  
			...
			<p align="justify">  
				<b>บทนำ</b><br />
				อัพเดทล่าสุดเมื่อ วันที่ 21 มกราคม พ.ศ.2557<br />
...
<form method="post" action="admin.php?page=capthsetting">
  ...
  <table width="930" border="0">
    ...
    <tr>
      ...
      <td><span class="style89">
        <label>
        <input type="checkbox" name="question_type5" value="yes" <?= ('yes' == $options['question_type5']) ? "checked='checked'" : NULL ?> />&nbsp;&nbsp;การคำนวณทางคณิตศาสตร์ &nbsp;&nbsp;</label>
      </span></td>
      <td>&nbsp;</td>
      <td> </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        <label>
        <select id="font_name" name="font_name" size="0.5" onclick="show_all()">
    ...
    <tr>
      ...
      <td>
        <label>ลักษณะของเส้น
        <select id="line" name="line" size="0.5" onclick="show_all()">
          ...
          <option value="curve">เส้นโค้ง</option>
          <option value="wavy">เส้นหยัก</option>
        </select>
        </label>
      </td>
      </tr>
    ...
    <tr>
      ...
      <td><span class="style89">กว้าง</span></td>
      <td>
        <label>
        <input type="text" name="width_frame" value="<?php global $options; echo $options['width_frame']?>" autocomplete="off" required>
        </label>
      </td>
      <td>(ระหว่าง 200 ถึง  465)</td>
    </tr>
    <tr>
      <td> </td>
      <td><span class="style89">สูง</span></td>
      <td>
      	<label>
        <input type="text" name="height_frame" value="<?php global $options; echo $options['height_frame']?>" autocomplete="off" required>
        </label>
      </td>
      <td>(ระหว่าง 105 ถึง  400)</td>
    </tr>
    <tr>
...
&#3626;&#3640;&#3656;&#3617;&#3626;&#3637;&#3605;&#3633;&#3623;&#3629;&#3633;&#3585;&#3625;&#3619;&#3649;&#3621;&#3632;&#3626;&#3637;&#3614;&#3639;&#3657;&#3609;&#3627;&#3621;&#3633;&#3591;</label>
    ...
    <tr>
      ...
      <td><span class="style87">
        <label>
        <input type="checkbox" name="hide_register_user" value="yes" <?= ('yes' == $options['hide_register_user']) ? "checked='checked'" : "'no' = {$options['hide_register_user']}" ?> />ซ่อนเมื่อ login แล้ว</label></td>
      <td><span class="style87">
        <label>
...
&#3626;&#3640;&#3656;&#3617;&#3626;&#3637;&#3605;&#3633;&#3623;&#3629;&#3633;&#3585;&#3625;&#3619;&#3649;&#3621;&#3632;&#3626;&#3637;&#3614;&#3639;&#3657;&#3609;&#3627;&#3621;&#3633;&#3591;</label>
  ...
  <input type="hidden" name="app_key" value="<?= $options['app_key']; ?>" /><br />
  <input type="hidden" name="user_agreement" value="<?= $options['user_agreement']; ?>" /><br />
  <input type="hidden" name="ctr" value="<?= $options['ctr']; ?>" /><br />
</form>
...
<script type="text/javascript">
    <!--    
        ...
        {
            url = "<?= plugins_url("captcha-in-thai-2nd/show_in_settings.php")  ?>";
...
<script type="text/javascript" src=<?=plugins_url("captcha-in-thai-2nd/jscolor/jscolor.js")?>></script>
